...
usage="yarn <deploy,test> [-h] [-c <eth,bsc,polygon,avalanche,fantom,cronos,aurora,arbitrum,klaytn,base>] [-n <mainnet,testnet,ropsten,goerli,rinkeby,staging,fuji>] -- to run test on specific chain and network
